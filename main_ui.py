...
"}")
        ...
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.contentTopBg)
        ...
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.leftBox)
        ...
        self.horizontalLayout_10.addWidget(self.leftBox)
        ...
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(self.rightButtons)
        ...
        self.maximizeAppBtn.setMinimumSize(QtCore.QSize(28, 28))
        self.maximizeAppBtn.setMaximumSize(QtCore.QSize(28, 28))
        self.maximizeAppBtn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.maximizeAppBtn.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/images/icon_maximize.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.maximizeAppBtn.setIcon(icon1)
        self.maximizeAppBtn.setIconSize(QtCore.QSize(20, 20))
        self.maximizeAppBtn.setObjectName("maximizeAppBtn")
        self.horizontalLayout_12.addWidget(self.maximizeAppBtn)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/images/icon_close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.horizontalLayout_10.addWidget(self.rightButtons, 0, QtCore.Qt.AlignRight)
...
"border-radius:15px;")
        ...
        self.btnProject = QtWidgets.QPushButton(self.loginFrame)
        self.btnProject.setMinimumSize(QtCore.QSize(110, 45))
        self.btnProject.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnProject.setStyleSheet("background-color: #3F3F3F;")
        self.btnProject.setAutoDefault(False)
        self.btnProject.setDefault(False)
        self.btnProject.setFlat(False)
        self.btnProject.setObjectName("btnProject")
        self.verticalLayout_4.addWidget(self.btnProject)
        self.btnMachine = QtWidgets.QPushButton(self.loginFrame)
        self.btnMachine.setMinimumSize(QtCore.QSize(110, 45))
        self.btnMachine.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnMachine.setStyleSheet("background-color: #3F3F3F;")
        self.btnMachine.setAutoDefault(False)
        self.btnMachine.setDefault(False)
        self.btnMachine.setFlat(False)
        self.btnMachine.setObjectName("btnMachine")
        self.verticalLayout_4.addWidget(self.btnMachine)
        self.btnSubject = QtWidgets.QPushButton(self.loginFrame)
        self.btnSubject.setMinimumSize(QtCore.QSize(110, 45))
        self.btnSubject.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnSubject.setStyleSheet("background-color: #3F3F3F;")
        self.btnSubject.setAutoDefault(False)
        self.btnSubject.setDefault(False)
        self.btnSubject.setFlat(False)
        self.btnSubject.setObjectName("btnSubject")
        self.verticalLayout_4.addWidget(self.btnSubject)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_4.addItem(spacerItem)
        self.horizontalLayout.addWidget(self.loginFrame)
        self.gridLayout.addWidget(self.leftMenu, 4, 0, 2, 1)
...
"border-radius:15px;")
        ...
        self.dateTimeTemps = QtWidgets.QDateTimeEdit(self.frame_6)
        self.dateTimeTemps.setMinimumSize(QtCore.QSize(0, 28))
        self.dateTimeTemps.setStyleSheet("background-color:white;")
        self.dateTimeTemps.setObjectName("dateTimeTemps")
        self.horizontalLayout_2.addWidget(self.dateTimeTemps)
        self.txtHours = QtWidgets.QLineEdit(self.frame_6)
        self.txtHours.setMinimumSize(QtCore.QSize(70, 28))
        self.txtHours.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.txtHours.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"padding:3px;\n"
"")
        self.txtHours.setObjectName("txtHours")
        self.horizontalLayout_2.addWidget(self.txtHours)
...
"color:black;")
        ...
        self.txtMinutes = QtWidgets.QLineEdit(self.frame_6)
        self.txtMinutes.setMinimumSize(QtCore.QSize(70, 28))
        self.txtMinutes.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.txtMinutes.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"padding:3px;\n"
"")
        self.txtMinutes.setObjectName("txtMinutes")
        self.horizontalLayout_2.addWidget(self.txtMinutes)
...
"color:black;")
        ...
        self.txtQuoteNumber = QtWidgets.QLineEdit(self.frame_14)
        self.txtQuoteNumber.setMinimumSize(QtCore.QSize(270, 28))
        self.txtQuoteNumber.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.txtQuoteNumber.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"padding:3px;\n"
"")
        self.txtQuoteNumber.setObjectName("txtQuoteNumber")
        self.gridLayout_3.addWidget(self.txtQuoteNumber, 0, 1, 1, 1)
        ...
        self.cmbxMachines = QtWidgets.QComboBox(self.frame_14)
        self.cmbxMachines.setMinimumSize(QtCore.QSize(0, 28))
        self.cmbxMachines.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"padding:3px;\n"
"")
        self.cmbxMachines.setObjectName("cmbxMachines")
        self.gridLayout_3.addWidget(self.cmbxMachines, 1, 1, 1, 1)
        self.cmbxSubjects = QtWidgets.QComboBox(self.frame_14)
        self.cmbxSubjects.setMinimumSize(QtCore.QSize(0, 28))
        self.cmbxSubjects.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"padding:3px;\n"
"")
        self.cmbxSubjects.setObjectName("cmbxSubjects")
        self.gridLayout_3.addWidget(self.cmbxSubjects, 2, 1, 1, 1)
        ...
        self.label_16.setStyleSheet("font: bold 11pt \"Arial\";")
        ...
        self.btnAddProject = QtWidgets.QPushButton(self.frame_15)
        self.btnAddProject.setMinimumSize(QtCore.QSize(120, 35))
        self.btnAddProject.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnAddProject.setStyleSheet("padding:5px;\n"
"border-radius:10px;\n"
"color: rgb(255, 255, 255);\n"
...
"border-radius:15px;")
        ...
        self.txtMachineName = QtWidgets.QLineEdit(self.frame_11)
        self.txtMachineName.setMinimumSize(QtCore.QSize(270, 28))
        self.txtMachineName.setMaximumSize(QtCore.QSize(400, 16777215))
        self.txtMachineName.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"padding:3px;\n"
"")
        self.txtMachineName.setObjectName("txtMachineName")
        self.gridLayout_2.addWidget(self.txtMachineName, 0, 1, 1, 1)
        ...
        self.cmbxTechnology = QtWidgets.QComboBox(self.frame_11)
        self.cmbxTechnology.setMinimumSize(QtCore.QSize(0, 28))
        self.cmbxTechnology.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"padding:3px;\n"
"")
        self.cmbxTechnology.setObjectName("cmbxTechnology")
        self.cmbxTechnology.addItem("")
        self.cmbxTechnology.setItemText(0, "")
        self.cmbxTechnology.addItem("")
        self.cmbxTechnology.addItem("")
        self.cmbxTechnology.addItem("")
        self.cmbxTechnology.addItem("")
        self.cmbxTechnology.addItem("")
        self.gridLayout_2.addWidget(self.cmbxTechnology, 1, 1, 1, 1)
        ...
        self.btnAddMachine = QtWidgets.QPushButton(self.frame_13)
        self.btnAddMachine.setMinimumSize(QtCore.QSize(120, 35))
        self.btnAddMachine.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnAddMachine.setStyleSheet("padding:5px;\n"
"border-radius:10px;\n"
"color: rgb(255, 255, 255);\n"
"    font: bold 10pt \"Arial\";background-color: #121212;")
        ...
        self.suvjectFrame = QtWidgets.QFrame(self.page_6)
        self.suvjectFrame.setMinimumSize(QtCore.QSize(520, 270))
        self.suvjectFrame.setMaximumSize(QtCore.QSize(16777215, 200))
        self.suvjectFrame.setStyleSheet("background-color: #7A8A8A;\n"
"border-radius:15px;")
        self.suvjectFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.suvjectFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.suvjectFrame.setObjectName("suvjectFrame")
        self.verticalLayout_17 = QtWidgets.QVBoxLayout(self.suvjectFrame)
        self.verticalLayout_17.setContentsMargins(-1, -1, 30, -1)
        self.verticalLayout_17.setObjectName("verticalLayout_17")
        self.frame_16 = QtWidgets.QFrame(self.suvjectFrame)
        ...
        self.label_14.setStyleSheet("font: bold 12pt \"Arial\";")
        ...
        self.frame_17 = QtWidgets.QFrame(self.suvjectFrame)
        self.frame_17.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_17.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_17.setObjectName("frame_17")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.frame_17)
        self.gridLayout_4.setContentsMargins(30, -1, 70, -1)
        ...
        self.label_15.setMaximumSize(QtCore.QSize(0, 16777215))
        self.label_15.setStyleSheet("font: bold 11pt \"Arial\";")
        self.label_15.setObjectName("label_15")
        self.gridLayout_4.addWidget(self.label_15, 0, 0, 1, 1)
        self.txtSubject = QtWidgets.QLineEdit(self.frame_17)
        self.txtSubject.setMinimumSize(QtCore.QSize(430, 28))
        self.txtSubject.setMaximumSize(QtCore.QSize(400, 16777215))
        self.txtSubject.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:8px;\n"
"padding:3px;\n"
"")
        self.txtSubject.setObjectName("txtSubject")
        self.gridLayout_4.addWidget(self.txtSubject, 0, 1, 1, 1)
        self.verticalLayout_17.addWidget(self.frame_17)
        self.frame_18 = QtWidgets.QFrame(self.suvjectFrame)
        ...
        self.btnAddSubject = QtWidgets.QPushButton(self.frame_18)
        self.btnAddSubject.setMinimumSize(QtCore.QSize(120, 35))
        self.btnAddSubject.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnAddSubject.setStyleSheet("padding:5px;\n"
"border-radius:10px;\n"
"color: rgb(255, 255, 255);\n"
"    font: bold 10pt \"Arial\";background-color: #121212;")
        self.btnAddSubject.setAutoDefault(False)
        self.btnAddSubject.setDefault(False)
        self.btnAddSubject.setFlat(False)
...
"border-radius: 10px;")
        ...
        self.gridLayout.addWidget(self.mainFrame, 4, 1, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.maximizeAppBtn.setToolTip(_translate("MainWindow", "Minimize"))
        ...
        self.label_16.setText(_translate("MainWindow", "Matière"))
        self.btnAddProject.setText(_translate("MainWindow", "AJOUTER "))
        ...
        self.cmbxTechnology.setItemText(1, _translate("MainWindow", "FDM"))
        self.cmbxTechnology.setItemText(2, _translate("MainWindow", "CFF"))
        self.cmbxTechnology.setItemText(3, _translate("MainWindow", "SLS"))
        self.cmbxTechnology.setItemText(4, _translate("MainWindow", "SLA"))
        self.cmbxTechnology.setItemText(5, _translate("MainWindow", "DLP"))
        self.btnAddMachine.setText(_translate("MainWindow", "AJOUTER "))
